...
(define-constant +float-array-specializable+
  (iter (for type in +supported-floats+)
        (always (eq type (upgraded-array-element-type type))))
  :test 'eq
  :documentation "Whether float arrays are always specialized to the appropriate type.")
